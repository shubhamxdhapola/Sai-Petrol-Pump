...
const getOverviewCards = async (startDate, endDate) => {
...
const getFuelSoldSummary = async (startDate, endDate) => {
...
const getRevenueChart = async (startDate, endDate, period) => {
...
const getFuelSoldChart = async (startDate, endDate, period) => {
    const result = await Shift.aggregate([{
        $match: {
            status: "COMPLETED",
            endTime: { $gte: startDate, $lte: endDate }
